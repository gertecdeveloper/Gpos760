package com.exampledv.gpos760.PagTEF;
...
import com.exampledv.gpos760.Impressora.tPRNTR;
import com.exampledv.gpos760.R;
...
//                }
    ...
    private void dialogImpressaoGPOS(String texto, int size) {
        ...
        alertDialog.setButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE, "Sim", new DialogInterface.OnClickListener() {
            @Override
        ...
        alertDialog.setButton(androidx.appcompat.app.AlertDialog.BUTTON_NEGATIVE, "Não", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                //        não executa nada
            }
