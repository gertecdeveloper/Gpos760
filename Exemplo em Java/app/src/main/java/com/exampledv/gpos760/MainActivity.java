...
import com.exampledv.gpos760.Camera.CodigoDeBarras;
import com.exampledv.gpos760.Camera.Scanner;
import com.exampledv.gpos760.Impressora.Printer;
import com.exampledv.gpos760.LeituraMifare.Mifare;
import com.exampledv.gpos760.PagTEF.Tef;
        ...
        infor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog alertDialog = new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setMessage("Equipamento: GPOS760\nSDK: libgedi-0.18.16.f4e9c73-gpos760-payment-release\nLinguagem: Java\nVersão do app: 1.0.0")
